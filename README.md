...
Monorepo NestJS 11 con MongoDB, Inngest, Playwright y patrones extensibles para servicios backend.
...
| `@common/inngest` | Cola de tareas + eventos |
...
- **Task queue:** Inngest 4 (self-hosted)
